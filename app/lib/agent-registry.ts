...
export const AGENTS: AgentDefinition[] = [
  ...
  },
  {
    ...
    demoHint: "当前使用虚构 FAQ、订单、商品和服务数据，可运行意图识别、针对性追问、业务查询、专业 Agent 路由和转人工建议；不会执行退款、信用处理或真实转接。",
    prompts: ["我想购买巡检无人机，但不知道应该从哪里开始选", "帮我查一下订单 JDZ-DEMO-1001 为什么物流还没更新", "订单 JDZ-DEMO-1002 的退款什么时候能处理？", "我要投诉并转人工客服处理"],
    workflow: "LangGraph 多意图客服路由", trace: ["识别咨询意图", "选择服务路径", "调用知识与业务工具", "重排答复依据", "生成客服答复与路由", "评估人工介入条件", "输出客服处理结果"],
    traceNotes: ["板块 / 问题类型 / 实体 / 置信度", "FAQ / 业务数据 / 专业Agent / 人工", "调用 CustomerServiceDataPort", "只保留直接相关依据", "形成答复与下一步建议", "高风险、投诉或明确请求转人工", "保留会话摘要和未执行声明"],
  },
];

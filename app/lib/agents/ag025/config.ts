...
export const AG025_CONFIG = {
  ...
  capabilityCoverage: [
    adapterReady("070-A-001", "运营问数意图理解"), adapterReady("070-A-001", "运营问数分析方案生成"), adapterReady("070-A-002", "运营指标口径理解"), adapterReady("070-A-003", "分析时间范围理解"), adapterReady("070-A-004", "业务筛选条件理解"), adapterReady("070-A-006", "缺失问数条件追问"), adapterReady("070-A-007", "问数结果摘要生成"), adapterReady("070-A-008", "单指标异常关联线索分析"), adapterReady("070-A-009", "跨指标经营原因辅助分析"), adapterReady("070-A-010", "后续分析问题建议"),

...
export const AG025_CONFIG = {
  ...
  capabilityCoverage: [
    adapterReady("070-A-001", "运营问数意图理解"), adapterReady("070-A-006", "缺失问数条件追问"),
    ...
    adapterReady("085-A-022", "客服会话违规风险线索识别"), adapterReady("085-A-024", "违规行为证据提取"), adapterReady("085-A-025", "重复违规线索识别"), adapterReady("085-A-028", "信用影响复核材料生成"),
    ...
    adapterReady("353-A-001", "投融资问题识别"), adapterReady("353-A-002", "投融资阶段流程场景解答"), adapterReady("353-A-003", "融资沟通材料清单生成"), adapterReady("353-A-004", "投融资通用风险事项场景解释"), adapterReady("353-A-005", "融资方式适用特点解释"), adapterReady("353-A-006", "融资阶段关键事项解答"), adapterReady("353-A-007", "融资沟通材料缺口说明"), adapterReady("358-A-001", "信贷问题识别"), adapterReady("358-A-002", "企业信贷申请流程场景解答"), adapterReady("358-A-003", "信贷材料清单生成"), adapterReady("358-A-004", "信贷通用风险事项场景解释"), adapterReady("358-A-005", "信贷条件场景适用性解释"), adapterReady("358-A-006", "还款方式差异解读"), adapterReady("358-A-007", "信贷材料缺口说明"),
  ],
} as const;
